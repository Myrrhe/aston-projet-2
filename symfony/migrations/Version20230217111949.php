 ...
 */
final class Version20230217111949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pharmacy (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) NOT NULL, head VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pharmacy_medication (id INT AUTO_INCREMENT NOT NULL, pharmacy_id_id INT NOT NULL, medication_id_id INT NOT NULL, unit_price INT NOT NULL, current_inventory INT NOT NULL, minimum_inventory INT NOT NULL, INDEX IDX_9C34A9376B6F30B (pharmacy_id_id), INDEX IDX_9C34A93E6161CBD (medication_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pharmacy_medication ADD CONSTRAINT FK_9C34A9376B6F30B FOREIGN KEY (pharmacy_id_id) REFERENCES pharmacy (id)');
        $this->addSql('ALTER TABLE pharmacy_medication ADD CONSTRAINT FK_9C34A93E6161CBD FOREIGN KEY (medication_id_id) REFERENCES medication (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pharmacy_medication DROP FOREIGN KEY FK_9C34A9376B6F30B');
        $this->addSql('ALTER TABLE pharmacy_medication DROP FOREIGN KEY FK_9C34A93E6161CBD');
        ...
        $this->addSql('DROP TABLE pharmacy_medication');
